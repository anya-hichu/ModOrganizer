...
public class NamedContainerReaderBuilder : IBuilder<NamedContainerReader>, IStubbableAssert, IStubbableContainerReader, IStubbablePluginLog
{
    ...
    public NamedContainerReader Build() => new(AssertStub, ContainerReaderStub, PluginLogStub);
}
