...
public class NamedContainerReaderBuilder : IBuilder<NamedContainerReader>, IStubbableContainerReader, IStubbablePluginLog
{
    ...
    public NamedContainerReader Build() => new(ContainerReaderStub, PluginLogStub);
}
