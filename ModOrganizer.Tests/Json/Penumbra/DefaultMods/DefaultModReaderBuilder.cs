...
public class DefaultModReaderBuilder : IBuilder<DefaultModReader>, IStubbableAssert, IStubbableContainerReader, IStubbableElementReader, IStubbablePluginLog
{
    ...
    public DefaultModReader Build() => new(AssertStub, ContainerReaderStub, ElementReaderStub, PluginLogStub);
}
