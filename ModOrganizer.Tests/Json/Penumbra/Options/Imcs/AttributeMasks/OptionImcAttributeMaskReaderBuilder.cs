...
public class OptionImcAttributeMaskReaderBuilder : IBuilder<OptionImcAttributeMaskReader>, IStubbableOptionReader, IStubbablePluginLog
{
    public StubIReader<Option> OptionReaderStub { get; init; } = new() { InstanceBehavior = StubBehaviors.NotImplemented };
    public StubIPluginLog PluginLogStub { get; init; } = new() { InstanceBehavior = StubBehaviors.NotImplemented };

    public OptionImcAttributeMaskReader Build() => new(OptionReaderStub, PluginLogStub);
}
